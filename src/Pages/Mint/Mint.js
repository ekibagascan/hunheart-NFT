...
import Video from "../../video/mintback.mp4";
...
const Mint = () => {
  ...
  return (
    <s.Screen>
      <s.Container flex={1} ai={"center"} style={{ padding: "24px 38px 24px" }}>
        <HeroBg>
        ...
        <ResponsiveWrapper flex={1} test>
          ...
          >
            ...
            <s.SpacerSmall />
            <Image src="/config/images/logo.gif" alt="Hunhea" />
            <s.SpacerSmall />
            <Typography
              variant="subtitle1"
              sx={{ fontWeight: "normal", color: "#FFFFFF" }}
            >
