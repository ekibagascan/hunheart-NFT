...
// import hunhea from "../../images/first.png";
      ...
      <InfoWrapper>
        ...
        <InfoRoad>
          ...
          <Column2>
            ...
            <Col2Grid>
              <Heading>{CONFIG.FIRST_ROADMAP_6_HEADING}</Heading>
              <Grid
                style={{
                  display: "block",
                  textAlign: "left",
              ...
              >
                <Subheading>{CONFIG.FIRST_ROADMAP_6_SUBHEADING}</Subheading>
                <Subtitle>{CONFIG.FIRST_ROADMAP_6_DESCRIPTIONS}</Subtitle>
              </Grid>
            </Col2Grid>
          </Column2>
        </InfoRoad>
